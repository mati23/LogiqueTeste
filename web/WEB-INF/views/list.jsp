                    ...
                    <div class="list-container">
                        <table class="table table-dark">
                            ...
                            <tr>
                                ...
                                <th scope="col">URL Comprimida</th>

                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="li" items="${urls}">
                            <tr>
                                <th scope="row"><c:out value="${li.id}" /></th>
                                <td class="original-link"><c:out value="${li.originUrl}" /></td>
                                <td><c:out value="${li.shortUrl}" /></td>
                            </tr>
                            </c:forEach>
